...
public abstract class ReactWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static ReactWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(ReactWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<ReactDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<ReactDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<ReactDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<ReactDbContext, Task<T>> func)
    {
        T result;
